...
return (
  `<body>
    <div style="margin:2em; max-width:40em; font-family:sans-serif;">
      ...
      <br>
      <p>For delivery at <b>${formatTime(recieptDetails.deliveryTime)}</b> on <b>${formatDate(recieptDetails.deliveryTime)}</b> to <b>${recieptDetails.deliveryPoint}</b> at <b>${recieptDetails.expoName}, ${recieptDetails.expoCenter}</b></p>
      <br>
      <br>

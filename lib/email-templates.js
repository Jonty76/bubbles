...
console.log("tip>>>>>>", formatPrice(recieptDetails.tip))
return (
  `<body>
    <div style="margin:2em; max-width:40em; font-family:sans-serif;">
      ...
      <p>For delivery at ${formatTime(recieptDetails.deliveryTime)} on ${formatDate(recieptDetails.deliveryTime)} to ${recieptDetails.deliveryPoint}</p>
      <br>
      <br>
      <div>
      ...
      <a href="bubbles-mvp.herokuapp.com/#/expo-cancel-order/${recieptDetails.orderNumber}/${recieptDetails.deliveryTime}">CANCEL ORDER</a>

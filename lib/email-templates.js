...
function formatDate (dateObject) {
  ...
  return formattedDate = d.getDate() + " " + month + " " + d.getFullYear();
}
...
return (
  `<body>
    <div style="margin:2em; max-width:40em; font-family:sans-serif;">
      ...
      <br>
      <p>For delivery at <b>${formatTime(recieptDetails.deliveryTime)}</b> on <b>${formatDate(recieptDetails.deliveryTime)}</b> to Stand: <b>${recieptDetails.deliveryPoint}</b> at <b>${recieptDetails.expoName}, ${recieptDetails.expoCenter}</b></p>
      <br>
      <br>
      ...
      <span style="color:#ED2C31;"><a href="bubbles-mvp.herokuapp.com/#/expo-cancel-order/${recieptDetails.orderNumber}/${recieptDetails.deliveryTime}"><b>CANCEL ORDER</b></a></span>
      ...
      <div style="margin-top: 2em;">
        ...
        <p style="color:#ED2C31; font-size: 1.2em;">Piccnicc: Hampers of Happiness, Delivered.</p>
...
var formatPiccniccReciept = function(recieptDetails) {
  return (
  `<body>
    <h2>Piccnicc Order Details for ${recieptDetails.firstName}, #${recieptDetails.orderNumber}</h2>
    <br>
    ...
    <p><b>First Name:</b> ${recieptDetails.firstName}</p>
    <p><b>Last Name:</b> ${recieptDetails.lastName}</p>
...
var formatFailedPayment = function(recieptDetails) {
  return (`<body><div><h2>Payment for order #${recieptDetails.orderNumber} for ${recieptDetails.firstName} ${recieptDetails.lastName} has failed.</h2></div></body>`)
};

...
return (
  `<body>
    <div style="margin:2em; max-width:40em; font-family:sans-serif;">
      ...
      <span style="color:#ED2C31;"><a href="piccnicc.herokuapp.com/#/expo-cancel-order/${recieptDetails.orderNumber}/${recieptDetails.deliveryTime}/${recieptDetails.email}"><b>CANCEL ORDER</b></a></span>
...
var formatCancelOrder = function(cancelDetails) {

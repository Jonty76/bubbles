...
function formatDate (dateObject) {
  ...
  return formattedDate = t.getDate() + " " + month + " " + t.getFullYear()
}
...
return (
  `<body>
    <div style="margin:2em; max-width:40em; font-family:sans-serif;">
      ...
      <p>For delivery on ${formatDate(recieptDetails.deliveryTime)} to ${recieptDetails.deliveryPoint}</p>
      <br>
      <br>
      <div>
...
var formatPiccniccReciept = function(recieptDetails) {
  return (
  `<body>
    <h2>Piccnicc Receipt for ${recieptDetails.firstName}, #${recieptDetails.orderNumber}</h2>
    <br>
    <p><b>Order Summary: #${recieptDetails.orderNumber} </b></p>
    <table>
      ${formatOrder(recieptDetails.order)}

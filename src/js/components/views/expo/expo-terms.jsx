      ...
      <div>
        ...
        <div className="desktop-container">
          <div className="content-container margin-all">
              ...
              <br></br>
              <h4>1. INFORMATION ABOUT US</h4>
              <p>piccnicc.com is a website operated by Picnicc Limited ("we", "us" or "Piccnicc"), incorporated and registered in the England and Wales, whose registered office is at 31, King Street West, Manchester, M3 2PJ, United Kingdom. Our Company registration number is 09691739. Our VAT number is 221 2207 71. Piccnicc is a business where the food is prepared by independent restaurants (the "Restaurants") and delivered by us.
              Piccnicc is not affiliated to or otherwise commercially engaged with any of the Restaurants and we do not make any representation, nor intend to create any expectation or understanding to the contrary in respect of you or any Restaurant.</p>
              <br></br>
              <h4>2. ACCESSING OUR SERVICE OR OUR SERVICES</h4>
              <p>Access to our Site and to our Service is permitted on a temporary basis, and we reserve the right to withdraw or amend access to our Site or our Service without notice (see below). We will not be liable if, for any reason, our Site or our Service is unavailable at any time or for any period. From time to time, we may restrict access to some parts our Site or our Service, or our entire Site or Service to users who have registered with us. You are responsible for maintaining the confidentially of your login details and any activities that occur under your account. If you have any concerns about your login details or think they have been misused, you should contact admin@piccnicc.com straight away to let us know. We can deactivate your account at any time.</p>
              <br></br>
              ...
              <br></br>
              <h4>4. INTERACTIVE FEATURES OF OUR SITE</h4>
              ...
              <p>Failure to comply with section 3 (Acceptable Use) and/or 5 (Content Standards) in these Terms of Use constitutes a material breach of the Terms of Use, and may result in our taking all or any of the following actions:
              ...
              The responses described in this clause are not limited, and we may take any other action we reasonably deem appropriate.</p>
              <br></br>
              ...
              <br></br>
              <h4>8. RELIANCE ON INFORMATION POSTED</h4>
              ...
              <br></br>
              <h4>9. OUR SITE AND OUR SERVICE CHANGE REGULARLY</h4>
              ...
              <br></br>
              <h4>11. INFORMATION ABOUT YOU AND YOUR VISITS TO OUR SITE AND USE OF OUR SERVICE</h4>
              ...
              <br></br>
              <h4>12. UPLOADING MATERIAL TO OUR SITE AND OUR SERVICE</h4>
              ...
              <br></br>
              <h4>14. JURISDICTION AND APPLICABLE LAW</h4>
              ...
              <p>If you have any concerns about material which appears on our Service, please contact <a className="link-text" href="mailto:admin@piccnicc.com">admin@piccnicc.com</a></p>
          </div>
        </div>
      </div>
    );

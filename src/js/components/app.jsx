...
module.exports = React.createClass({
  ...
  render: function() {
    ...
    return (
        <div>
          <RouteCSSTransitionGroup transitionName="example" transitionAppear={true} transitionAppearTimeout={1000} transitionEnterTimeout={2000} transitionLeaveTimeout={2000}>
              <Header />
              {child}
